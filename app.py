...
st.markdown(""" The most important feature for predicting whether someone's income is <=50k or >50k is relationship. 
...
st.markdown("""From the above plot we can understand.
...
st.markdown(""" The SHAP dependence plot with relationship and age shows that the relationship has a larger impact on the SHAP values for younger people than for older people. This means that the difference in SHAP values between people in a relationship and people not in a relationship is greater for younger people.
...
st.markdown("""There is a positive interaction between age and education num. This means that the positive effect of education num on expected income is greater for older people.
...
st.markdown("""There is a positive interaction between relationship and hours per week. This means that the positive effect of working more hours on expected income is greater for people in a relationship.
...
st.markdown("""The data point in question is a person who is 38 years old, has 16 years of education, and has an income of $50,000 per year. 
...
st.markdown("""The plot shows that the relationship feature has the biggest impact on the model's prediction. This is because people in a relationship are more likely to have children and other financial responsibilities, which can make it difficult for them to have a high income.
